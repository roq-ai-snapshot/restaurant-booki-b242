...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'restaurant.update': { roles: ['chef', 'guest'], key: 'restaurant-profile-updated', tenantPath: [], userPath: [] },
  'reservation.update': {
    roles: ['chef', 'guest'],
    key: 'table-reservation-changed',
    tenantPath: ['restaurant', 'reservation'],
    userPath: [],
  },
  'menu.update': { roles: ['guest'], key: 'menu-updated', tenantPath: ['restaurant', 'menu'], userPath: [] },
};
